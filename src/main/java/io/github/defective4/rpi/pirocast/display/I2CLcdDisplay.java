...
import io.github.defective4.rpi.pirocast.hardware.I2CDevice;
 ...
 */
public class I2CLcdDisplay extends I2CDevice implements TextDisplay {
     ...
     */
    public I2CLcdDisplay(Context pi4j) {
     ...
     */
    public I2CLcdDisplay(Context pi4j, int rows, int columns) {
     ...
     */
    public I2CLcdDisplay(Context pi4j, int rows, int columns, int device) {
